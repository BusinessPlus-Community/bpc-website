---
name: tailwindcss-v4
description: Apply Tailwind CSS v4 patterns for CSS-first configuration, new directives (@theme, @utility, @variant, @source), migration from v3, and anti-patterns to avoid. Use when writing Tailwind CSS, migrating from v3 to v4, configuring themes, or troubleshooting Tailwind issues.
---
...
<div class="@container">
  ...
  <div class="@lg:grid-cols-2 @md:flex-row">Content</div>
</div>
```
...
<div class="@container/sidebar">
  <div class="@lg/sidebar:hidden">Hidden when sidebar is large</div>
</div>
```
...
```html
<div class="bg-white dark:bg-gray-900">Follows system preference</div>
```
...
<html class="dark">
  <body>
    <div class="bg-white dark:bg-gray-900">Dark when .dark class on html</div>
  </body>
</html>
```
    ...
    <div class="text-[--heading-size]">
      ...
      <div class="w-[var(--sidebar-width)]">
        <div class="p-[var(--spacing-lg)]">
          <div class="text-[var(--heading-size)]"></div>
        </div>
      </div>
    </div>
  </div>
...
```html
<button class="hocus:bg-blue-600 pointer-coarse:p-4">Hover or focus me</button>
```
...
_Generated from 21 rules. Verified 15/15 tests passing._
